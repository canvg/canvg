---
id: "UnknownElement"
title: "Class: UnknownElement"
sidebar_label: "UnknownElement"
sidebar_position: 0
...
• **new UnknownElement**(`document`, `node`, `captureTextNodes?`)
...
[src/Document/UnknownElement.ts:5](https://github.com/canvg/canvg/blob/5c58ee8/src/Document/UnknownElement.ts#L5)
