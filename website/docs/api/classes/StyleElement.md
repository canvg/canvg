---
id: "StyleElement"
title: "Class: StyleElement"
sidebar_label: "StyleElement"
sidebar_position: 0
...
▪ `Static` `Readonly` **parseExternalUrl**: (`url`: `string`) => `string` = `parseExternalUrl`
...
[src/Document/StyleElement.ts:12](https://github.com/canvg/canvg/blob/5c58ee8/src/Document/StyleElement.ts#L12)
...
[src/Document/StyleElement.ts:14](https://github.com/canvg/canvg/blob/5c58ee8/src/Document/StyleElement.ts#L14)
...
• **new StyleElement**(`document`, `node`, `captureTextNodes?`)
...
[src/Document/StyleElement.ts:16](https://github.com/canvg/canvg/blob/5c58ee8/src/Document/StyleElement.ts#L16)
