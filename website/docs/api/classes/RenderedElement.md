---
id: "RenderedElement"
title: "Class: RenderedElement"
sidebar_label: "RenderedElement"
sidebar_position: 0
...
- [`Element`](Element.md)
  ...
  ↳↳ [`GElement`](GElement.md)

  ↳↳ [`SymbolElement`](SymbolElement.md)

  ↳↳ [`UseElement`](UseElement.md)
...
• `Private` **modifiedEmSizeStack**: `boolean` = `false`

#### Defined in

[src/Document/RenderedElement.ts:11](https://github.com/canvg/canvg/blob/5c58ee8/src/Document/RenderedElement.ts#L11)

## Constructors

### constructor

• **new RenderedElement**(`document`, `node?`, `captureTextNodes?`)
