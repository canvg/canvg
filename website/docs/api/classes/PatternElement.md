---
id: "PatternElement"
title: "Class: PatternElement"
sidebar_label: "PatternElement"
sidebar_position: 0
...
[src/Document/PatternElement.ts:7](https://github.com/canvg/canvg/blob/5c58ee8/src/Document/PatternElement.ts#L7)

## Constructors

### constructor

• **new PatternElement**(`document`, `node?`, `captureTextNodes?`)
...
▸ **createPattern**(`ctx`, `_`, `parentOpacityProp`): `CanvasPattern`
...
[src/Document/PatternElement.ts:9](https://github.com/canvg/canvg/blob/5c58ee8/src/Document/PatternElement.ts#L9)
